...
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/AAS_means.png')
```
...
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/AAS_qualtrics_scores.png')
```

##### *Qualtrics for Items 1-18*
```{r,  AAS-screenshot-qualtrics-items, echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/AAS_qualtrics_items.png')
```
...
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/BDI_items.png')
```

##### *Score Ranges*
```{r, BDI-screenshot-cutoffs,  echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/BDI_cutoffs.png')
```
...
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/BDI_means.png')
```
...
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/BDI_qualtrics_scores_q1.png')
```

##### *Scoring for Item 16*
```{r, BDI-screenshot-qualtrics-scoring-16,  echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/BDI_qualtrics_scores_q16.png')
```

##### *Scoring for Item 18*
```{r, BDI-screenshot-qualtrics-scoring-18,  echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/BDI_qualtrics_scores_q18.png')
```

#####  *Qualtrics Items 1-5*
```{r, BDI-screenshot-qualtrics-items-1to5,  echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/BDI_qualtrics_items_q1to5.png')
```

##### *Qualtrics Items 6-11*
```{r, BDI-screenshot-qualtrics-items-6to11, echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/BDI_qualtrics_items_q6to11.png')
```

##### *Qualtrics Items 12-16*
```{r, BDI-screenshot-qualtrics-items-12to16,  echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/BDI_qualtrics_items_q12to16.png')
```

##### *Qualtrics Items 17-21*
```{r, BDI-screenshot-qualtrics-items-17to21,  echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/BDI_qualtrics_items_q17to21.png')
```
...
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/BFI_qualtrics.png')
```
...
#### Qualtrics Scoring
```{r eval = !knitr::is_latex_output(), echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/COPE_qualtrics.png')
```
...
```{r  echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/DAS_scales.png')
```

```{r  echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/DAS_scales_descriptions.png')
```
...
## ECR: Experiences in Close Relationships—Revised {.tabset}
### Notes {.tabset}
#### General Notes
...
#### Qualtrics Scoring
```{r  echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/ECR_qualtrics.png')
```
...
```{r  echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/IRI_means.png')
```
...
```{r  echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/IRI qualtrics.png')
```
...
#### Qualtrics Scoring
```{r eval = !knitr::is_latex_output(), echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/ISS_qualtrics_scoring.png')
```
...
## LAPR: Life Attitudes Profile—Revised {.tabset}
### Notes {.tabset}
#### General Notes
...
```{r  echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/LAPR_likert.png')
```


##### LAP-R Subscales (from Erci)
```{r  echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/LAPR_subscales.png')
```
...
```{r  echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/LAPR_removed_items.png')
```


* Confirmation of item 16's wording can be found [here](https://onlinelibrary.wiley.com/doi/epdf/10.1002/pon.1755)
```{r  echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/LAPR_item_16.png')
```
...
##### Qualtrics Scores
```{r eval = !knitr::is_latex_output(), echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/LAPR_qualtrics_scoring.png')
```

##### Qualtrics Questions
```{r eval = !knitr::is_latex_output(), echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/LAPR_qualtrics_questions.png')
```
...
```{r  echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/LEC_questions_before65.png')
```

##### *LEC Scoring Before Couple 65*
```{r  echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/LEC_scores_before65.png')
```

##### *LEC Questions After Couple 65*
```{r  echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/LEC_questions_after65.png')
```
...
![LEC Scoring
Procedures](../HATCH_RA/scoring_instructions/images/LEC_scoring.png) from [VA
...
```{r eval = !knitr::is_latex_output(), echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/LES_subscales.png')
```

##### *Means from 1978 paper Paper*
```{r eval = !knitr::is_latex_output(), echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/LES_means.png')
```
...
##### *Coded values*
```{r eval = !knitr::is_latex_output(), echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/LES_qualtrics_scoring.png')
```

##### *Qualtrics items*
```{r eval = !knitr::is_latex_output(), echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/LES_qualtrics_items.png')
```
...
- Preoccupation: n = 8
```{r  echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/MAAS.PAAS_MAASsubscales.png')
```
*PAAS*
- Quality: n = 10
- Preoccupation: n = 6
```{r  echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/MAAS.PAAS_PAASsubscales.png')
```

##### *Scale Means*
```{r  echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/MAAS.PAAS_means.png')
```
...
```{r  echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/MAAS.PAAS_qualtrics.png')
```
...
```{r  echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/MOS_means.png')
```
...
```{r  echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/MOS_scoring.png')
```
...
#### Qualtrics Scoring
```{r  echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/MOS_qualtrics.png')
```
...
#### Scoring Instructions
```{r  echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/PAS_Scoring.png')
```
...
```{r  echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/PAS_SPSS_names.png')
```

#### Qualtrics Scoring
##### PAS Questions 1-6
```{r  echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/PAS_Qualtrics1.png')
```

##### PAS Questions 7-13
```{r  echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/PAS_Qualtrics2.png')
```
...
#### Qualtrics Scoring
```{r  echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/PSAM_Qualtrics.png')
```
...
```{r  echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/PSQI_q5.png')
```

##### *Questions 6-7*
*Scoring for 7 is the same as for 6 (which is listed below)*
```{r  echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/PSQI_q6-7.png')
```

##### *Question 8*
```{r  echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/PSQI_q8.png')
```

##### *Question 9*
```{r  echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/PSQI_q9.png')
```
...
##### *Score Ranges*
```{r  echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/PSS_cutoffs.png')
```
...
#### Qualtrics Scoring
```{r  echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/PSS_qualtrics.png')
```
...
## SCL: Symptom Checklist—90 {.tabset}
...
```{r  echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/SCL_scoring.png')
```

##### *Subscales* 
```{r  echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/SCL_subscales.png')
```

##### *Global Scales*
```{r  echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/SCL_GSI.png')
```

```{r  echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/SCL_PSDI.png')
```

```{r  echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/SCL_PST.png')
```

##### *Scale Means*
```{r  echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/SCL_means.png')
```
...
```{r  echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/SCL_qualtrics.png')
```
...
#### Scoring Instructions
```{r  echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/STAI_scoring_and_cutoffs.png')
```
...
#### Scoring Instructions
```{r  echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/WIAF_scoring.png')
```
...
#### Qualtrics Scoring
```{r  echo = FALSE}
knitr::include_graphics('../HATCH_RA/scoring_instructions/images/WIAF_Qualtrics.png')
```
